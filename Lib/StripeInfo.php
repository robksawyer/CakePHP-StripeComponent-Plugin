...
class StripeInfo {
  ...
  /**
    * Stripe configurations stored in
  ...
  static function getConfig($key = null){
    /*if (!empty($key)) {
			if (isset(self::$configs[$key]) || (self::$configs[$key] = Configure::read("Stripe.$key"))) {
				return self::$configs[$key];
			} elseif (Configure::load('stripe') && (self::$configs[$key] = Configure::read("Stripe.$key"))) {
				return self::$configs[$key];
			}
		} else {
			Configure::load('stripe');
			return Configure::read('Stripe');
		}*/
		return null;
  }
  
  /**
    * Get the version of the Stripe Plugin
  ...
  /**
    * Get the offical name of the Stripe Plugin
    * @return string plugin name
    */
  static function name(){
    return 'CakePHP Stripe Plugin';
  }
  ...
  static function email(){
    return 'robksawyer@gmail.com';
  }
  
  /**
    * Get the website for Stripe Plugin
    * @return string plugin link
    */
  static function link(){
    return 'http://www.robksawyer.com';
  }
  
  /**
    * Get the license for Stripe Plugin
  ...
  /**
    * Get the description for Stripe Plugin
    * @return string plugin description
    */
  static function description(){
    return "The purpose of the Stripe plugin is to 
	provide a seamless way to connect your cakePHP app 
	to a simple transaction service -- Stripe. 
